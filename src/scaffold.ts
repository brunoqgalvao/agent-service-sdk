...
export type ScaffoldServiceProjectOptions = {
  targetDir: string;
  serviceId: string;
  serviceName?: string;
  description?: string;
...
export async function scaffoldServiceProject(options: ScaffoldServiceProjectOptions) {
